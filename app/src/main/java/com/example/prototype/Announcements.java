...
public class Announcements extends BaseActivity implements ItemClickListener {
    ...
    private List<AnnouncementsItem> announcementsList = new ArrayList<>();
    TabLayout tabLayout;
    ...
    private void fetchAnnouncements() {
        String url = "http://192.168.100.4/MDOapp-main/Admin/announcement.php?type=all"; // Update this URL
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.GET, url, response -> {
            try {
                ...
                for (int i = 0; i < jsonArray.length(); i++) {
                    ...
                    announcementsList.add(0,new AnnouncementsItem(title, text, imageUrl));
                }
