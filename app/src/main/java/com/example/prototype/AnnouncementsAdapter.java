...
public class AnnouncementsAdapter extends RecyclerView.Adapter<AnnouncementsAdapter.ViewHolder> {
    private final List<AnnouncementsItem> announcementsList;

    public AnnouncementsAdapter(List<AnnouncementsItem> announcementsList) {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        AnnouncementsItem item = announcementsList.get(position);
