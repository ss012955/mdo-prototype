...
public class EventDecoratorPending implements DayViewDecorator {
    private final Set<CalendarDay> dates;

    public EventDecoratorPending(Set<CalendarDay> dates) {
        this.dates = dates;
    }
    ...
    public void decorate(DayViewFacade view) {
        ...
        circleDrawable.setColor(Color.parseColor("#F5EC3A"));  // Set the background color
